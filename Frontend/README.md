<h1 align="center">Blueprint.AI: Automatic SRS Generator App</h1>
...
1. **Clone the Repository:**
    ...
    ```sh
    git clone https://github.com/Zivanika/Automatic-SRS-Generation.git
    cd Automatic-SRS-Generation
    ```
